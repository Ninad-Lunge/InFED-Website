...
const VerticalNavbar = () => {
  ...
  return (
    <div className="m-2 h-min min-w-56 bg-black flex flex-col items-center justify-start p-2 rounded-lg">
      ...
      <button className="w-full bg-transparent text-white border-none py-3 px-4 text-left cursor-pointer text-lg mb-2 flex items-center" onClick={() => navigate('/manage-reports')}>
        <FaInfoCircle className="mr-2" /> Manage Reports
      </button>
