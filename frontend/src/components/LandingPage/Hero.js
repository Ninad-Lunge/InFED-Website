    ...
    return (
        <div className="hero flex flex-col md:flex-row m-5 md:ms-20 mt-20">
            <div className="left-side text-left w-full md:w-1/2 grid gap-y-4 order-2 md:order-1">
                ...
                <div className="text-2 text-lg md:text-2xl">
                    <p>
                        Start your{' '}
                ...
                <div className="buttons flex flex-row gap-x-4 md:gap-x-16 items-start">
                    <button className="incubation-btn p-2 md:px-4 md:py-2 bg-black text-white border border-black rounded-md" onClick={handleClick}>
                        Apply for Incubation
                    </button>
                    <button className="join-btn p-2 md:px-4 md:py-2 bg-white text-black border border-black rounded-md" onClick={handleClick}>
                        Join the Community
                    </button>
                </div>
            </div>
