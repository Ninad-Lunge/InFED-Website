    ...
    return (
        <div className="event md:mt-10">
            ...
            <div className="text-left md:mx-20 px-4 pt-8">
                <h1 className="text-3xl font-bold mb-4">InFED′s Privacy Policy</h1>
                ...
                <section className="mb-8 border-b border-gray-300 pb-8">
                    <h2 className="text-2xl font-semibold mb-3">Our Advertising Partners</h2>
                    <p className="">
                ...
                <section className="mb-8 border-b border-gray-300 pb-8">
                    <h2 className="text-2xl font-semibold mb-3">Advertising Partners Privacy Policies</h2>
                    <p className="">
                ...
                <section className="mb-8 border-b border-gray-300 pb-8">
                    <h2 className="text-2xl font-semibold mb-3">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                    <p className="">
